...
impl<const COLS: usize, const ROWS: usize> From<board::Cells<COLS, ROWS>>
    for SymmetricBoard<COLS, ROWS>
{
    fn from(board: board::Cells<COLS, ROWS>) -> Self {
        board.cells.into()
    }
}
